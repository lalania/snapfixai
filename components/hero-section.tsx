      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] items-center justify-center">
        <div className="flex flex-col justify-center space-y-4 text-center lg:text-left">
          <div className="space-y-2">
            <h1 className={cn("text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500", "mb-4")}>
              Perfect Photos, Every Time
            </h1>
            <p className={cn("max-w-[600px] text-gray-800 md:text-xl mx-auto lg:mx-0", "opacity-90")}>
              Instantly fix blinking eyes, remove red-eye, and enhance your photos with just one tap.
            </p>
          </div>
          <div className="w-full space-y-2 mx-auto lg:mx-0">
            <div className="flex flex-col sm:flex-row gap-2 w-full">
              ...
              <Button className="w-full bg-blue-600 text-white hover:bg-blue-700" size="lg">
                <svg viewBox="0 0 505.145 505.145" className="w-5 h-5 mr-2 fill-current">
                  <g>
